...
class BaseController extends Controller{
	...
	protected function initialize(){	
		...
		//不用用户登录可以访问的页面
		$no_user_id_arr	= array('code','login','language','checkslogin','sendsmscode','register','helps','resetpassword','backdata','createorder','goodlist','viplist','systemconfig','signin','gettaskranklist','gettaskclasslist','getvipuserexpire','gettasklist','gettaskinfo','taskordertrial');
