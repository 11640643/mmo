<?php /*a:1:{s:72:"/www/wwwroot/mmo.jrytc.cn/application/manage/view/base/pics_add_tyj.html";i:1661216539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form layui-form-pane" action="">
                            ...
                            <div class="layui-form-item" style="margin-top: 40px;text-align: center;">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit id="pic_upload" lay-filter="pic_upload">立即提2222222交</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
layui.use(['layer', 'element', 'form', 'upload', 'table'], function(){
    ...
    $("#pic_upload").on('click', function(){
        ...
        // pic_s.value = path;
        $("#uploadBtn2", window.parent.document).val(path);
